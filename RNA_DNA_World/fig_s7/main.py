...
while t<T:
	...
	# different type of strands per droplet
	...
	m=open('data.txt','a+')
	m.write('%f' %t + '\t' + '%f' %(tr/N) + '\t' + '%f' %(p/N) + '\t' + '%f' %(r/N) + '\t' + '%f' %(td/N) + '\t' + '%f' %(tdp/N) + '\t' + '%f' %(tdr/N) + '\n')
	m.close()

		
	# Export the time evolution data for the percentage 
	# of droplets containing different types of strands
	...
	# of all types of polymerization reactiions
	
	m=open('data2.txt','a+')
	m.write('%f' %t + '\t' + '%f' %(re1/N) + '\t' + '%f' %(re2/N) + '\t' + '%f' %(re3/N) + '\t' + '%f' %(re4/N) + '\t' + '%f' %(re5/N) + '\t' + '%f' %(re6/N) + '\t' + '%f' %(re7/N) + '\t' + '%f' %(re8/N) + '\t' + '%f' %(re9/N) + '\n')
	m.close()
